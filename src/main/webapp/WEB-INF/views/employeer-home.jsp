        ...
        <header class="header">
            <div class="row">
                ...
                <div class="menu_main_content col-xs-8">
                    ...
                    <div class="col-xs-3" style="background-color:black;"><a href="${contextPath}/employer/myjobposts.htm" style="color: lightgrey; text-decoration:none">View my Posts</a></div>
                </div>
            </div>
        </header>	
