...
<body>
    ...
    <div class="grid-2-6">
        ...
        <div id="div-location" class="error-wrap location">
            ...
            <div>
                <label for="majorCat">Industry<span class="asterisk">&#42;</span></label>
                <div>
                    ...
                    <label for="majorList">Major <span class="asterisk">&#42;</span></label><br>
        ...
        <div style="text-align:center;">
        	<input type = "submit" class="btn btn-success btn-lg btncss" value = "Post" />
        </div>
        </form>
        <div><br></div>
    </div>
